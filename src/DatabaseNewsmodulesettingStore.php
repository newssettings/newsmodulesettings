...
class DatabaseNewsmodulesettingStore extends NewsmodulesettingStore
{
	/**
	...
	public function __construct(Connection $connection, $table = null)
	{
		...
		$this->table = $table ?: 'persistant_newsmodulesettings';
	}
	...
	/**
	 * Transforms settings data nto an array ready to be insterted into the
	 * database. Call array_dot n a multidimensional array before passing it
	 * into this method!
	 *
	 * @param  array $data Call rray_dot on a multidimensional array before passing it into this method!
	 *
	 * @return array
	 */
